...
tab1, tab2, tab3 = st.tabs(['Remote Sensing & Flood Map','Inland Flood Model',"Salinity Model"])
...
with tab3:
    ...
    st.markdown("#### LSTM-based Salinity Model", unsafe_allow_html=True)
